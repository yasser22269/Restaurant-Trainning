						...
						<div class="profile-container">
							...
							<div class="profile-sidebar">
								<div class="desktop-sticky-top">
									...
									<div class="mb-1">
										<i class="fa fa-map-marker-alt fa-fw text-white text-opacity-50"></i> Address : {{$employees->address}}
									</div>
									<div class="mb-3">
									...
									<!-- people-to-follow -->
									<div class="fw-bold mb-3 fs-16px">Setting</div>
									<div class="d-flex align-items-center mb-3">
										<div class="flex-fill px-3">
											<div class="fw-bold text-truncate w-100px">Change password</div>
										</div>
										<a href="#" class="btn btn-sm btn-outline-theme fs-11px">Change</a>
									</div>
									<div class="d-flex align-items-center mb-3">
										<div class="flex-fill px-3">
											<div class="fw-bold text-truncate w-100px">Change information</div>
										</div>
										<a href="#" class="btn btn-sm btn-outline-theme fs-11px">Change</a>
									</div>
								</div>
